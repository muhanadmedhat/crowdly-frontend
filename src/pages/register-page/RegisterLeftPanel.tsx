export default function RegisterLeftPanel() {
  return (
    <div className="hidden md:flex flex-1 lg:flex-[1.1] bg-gradient-to-br from-[#f4f3ef] via-[#f4f3ef] to-[#ebd7ca] p-8 lg:p-12 flex-col justify-between h-full overflow-hidden">
        ...
        <div className="mb-14">
          ...
          <ul className="flex flex-col gap-6 xl:gap-8">
            <li className="flex items-center gap-5">
              ...
              <span className="text-xl text-[#333] leading-relaxed font-normal">Free to create</span>
            </li>
             <li className="flex items-center gap-5">
              <div className="w-7 h-7 text-[var(--color-primary)] shrink-0 flex justify-center items-center">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full"><path d="M3 3v18h18M7 16l4-4 4 4 6-6"/><path d="M21 10V4h-6"/></svg>
              </div>
              <span className="text-xl text-[#333] leading-relaxed font-normal">Trusted worldwide</span>
            </li>
             <li className="flex items-center gap-5">
              <div className="w-7 h-7 text-[var(--color-primary)] shrink-0 flex justify-center items-center">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z"/><path d="M10 15l-3-3 1.41-1.41L10 12.17l5.59-5.59L17 8l-7 7z" fill="white"/></svg>
              </div>
              <span className="text-xl text-[#333] leading-relaxed font-normal">Secure donations</span>
            </li>
          </ul>
        </div>
      </div>
